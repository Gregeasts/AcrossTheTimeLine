...
const learnData = {
   Russia: [
      ...
      { year: "1924-onwards", content: "Molotov joined bolsheviks in 1906 and was part of the seizure of power in petrograd in 1917. He was second secretary from 1922 and a loyal ally of Stalin who replaced Rykov as party chair in 1930 and was minister of foreign affaris from 1939-49.", category: "Political" },
      { year: "1924-onwards", content: "Kaganovich - loyal support of Stalin who ran the party bureaucracy and joined the poltiburo in 1930. He was blamed as chief cause of great famine due to his forced collectivisation policies and he lost power after Stalins death.", category: "Political" },
      { year: "1924-onwards", content: "Kirov was active in the revolution of 1917 and a military commander in North Caucasus in Civil War. He was handpicked to replace Zinoviev as party boss in Lenigrad in 1926. He was very popular in party and assassinated by Stalin's secret orders due to this in 1934.", category: "Political" }, 
  ...
  const quizData = {
    Russia: [
      ...
      { year: 1925, question: "What were the key developments in the power struggle in 1925 and how did the party factions shift?", answer: "Trotsky was forced out as Commissar for War in January. Though Zinoviev called for his expulsion, Stalin resisted. By September, Kamenev and Zinoviev opposed Stalin and joined Trotsky. Stalin allied with Bukharin, forming the 'duumvirate' that effectively ruled the USSR from 1926–27.", category: "Political" },
      ...
      { year: 1927, question: "How did Stalin handle the political instability in China between 1925 and 1927, and what were the outcomes of his support for the Guomindang (GMD)?", answer: "Stalin supported the Guomindang (GMD) in China over the Communist Party, preferring their stability. Between 1925 and 1927, the GMD massacred thousands of striking workers and suppressed communist uprisings. Despite these actions, Stalin continued to back the GMD, believing their leadership would provide the necessary stability for China. Stalin's foreign policy in China was controversial, particularly criticized by Trotsky.", category: "Foreign Policy/International" },
      ...
      { year: 1928, question: "What were the goals of the First Five-Year Plan in 1928, and how did it impact Soviet industry and agriculture? What was the expected increase in production by 1933?", answer: "The First Five-Year Plan, launched in 1928, aimed for a 300% increase in industrial output, focusing on heavy industries such as coal, iron, and steel. It also aimed to electrify the country, increasing electric power by 600% by 1933. While the plan prioritized industrial development, it also pushed for rapid collectivization, despite resistance from peasants. This aggressive push for collectivization led to significant social and economic unrest.", category: "Economic" },
